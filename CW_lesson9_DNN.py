...
while True:
    ...
    (h, w) = frame.shape[:2] # для масштабування

    blob = cv2.dnn.blobFromImage(frame, 1.0, (300, 300), (104.0, 177.0, 123.0)) # багатовимірний масив з зображень адаптованих під наш массив
